...
class ValidationServiceTest extends WebTestCase
{
    ...
    public function testSmallField(): void
    {
        ...
        self::assertSame(['Must be 60 characters or less'],$this->validationService->smallField('ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss'));
        self::assertSame(['Must be 60 characters or less', 'Can contain letters, numbers, !@#$%^&*()_-=+;:\'\"?,<>[]{}\|/№!~\' symbols, and one dot not first or last'],$this->validationService->smallField('ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss.'));
        self::assertSame(['Can contain letters, numbers, !@#$%^&*()_-=+;:\'\"?,<>[]{}\|/№!~\' symbols, and one dot not first or last'], $this->validationService->smallField('.s.'));
        self::assertSame(['Must be 2 characters or more', 'Can contain letters, numbers, !@#$%^&*()_-=+;:\'\"?,<>[]{}\|/№!~\' symbols, and one dot not first or last'], $this->validationService->smallField('.'));
        self::assertSame(['Can contain letters, numbers, !@#$%^&*()_-=+;:\'\"?,<>[]{}\|/№!~\' symbols, and one dot not first or last'], $this->validationService->smallField('...'));
        self::assertSame(['Can contain letters, numbers, !@#$%^&*()_-=+;:\'\"?,<>[]{}\|/№!~\' symbols, and one dot not first or last'], $this->validationService->smallField(' ⅚ ⅜ ⅝ ⅞'));
        self::assertSame('Field2021ЯяЁё !@#$%^&*()_-=+;:\'\"?,<>[]{}\|/№!~\'', $this->validationService->smallField('    Field2021ЯяЁё !@#$%^&*()_-=+;:\'\"?,<>[]{}\|/№!~\''));
    }

    public function testBigField():void
    {
        self::assertSame(['Must be 2 characters or more'], $this->validationService->bigField('s'));
        self::assertSame(['Must be 2 characters or more', 'Can contain letters, numbers, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last'], $this->validationService->bigField('.'));
        self::assertSame(['Must be 255 characters or less'], $this->validationService->bigField('С другой стороны рамки и место обучения кадров способствует подготовки и реализации модели развития. С другой стороны рамки и место обучения кадров способствует подготовки и реализации модели развития. Идейные соображения высшего порядка, а также начало повседневной работы по формированию позиции позволяет оценить значение модели  развития'));
        self::assertSame(['Must be 255 characters or less', 'Can contain letters, numbers, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last'], $this->validationService->bigField('С другой стороны рамки и место обучения кадров способствует подготовки и реализации модели развития. С другой стороны рамки и место обучения кадров способствует подготовки и реализации модели развития. Идейные соображения высшего порядка, а также начало повседневной работы по формированию позиции позволяет оценить значение модели  развития.'));
        self::assertSame(['Can contain letters, numbers, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last'], $this->validationService->bigField('.w.'));
        self::assertSame(['Can contain letters, numbers, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last'], $this->validationService->bigField('...'));
        self::assertSame(['Can contain letters, numbers, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last'], $this->validationService->bigField('⅚ ⅜ ⅝ ⅞'));
        self::assertSame('Can contain AaФфёЁ, 0123456789, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last', $this->validationService->bigField('       Can contain AaФфёЁ, 0123456789, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last'));
    }

    public function  testPassword():void
    {
        self::assertSame(["Must be 8 characters or more"], $this->validationService->password(1234567));
        self::assertSame(["Must be 8 characters or more", 'Can contain letters, numbers, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last'], $this->validationService->password('123456.'));
        self::assertSame(["Must be 32 characters or less", 'Can contain letters, numbers, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last'], $this->validationService->password('С другой стороны укрепление и развитие структуры обеспечивает участие в формировании систем массового участия.'));
        self::assertSame(["Must be 32 characters or less"], $this->validationService->password('1234567891234567891234567891234566'));
        self::assertSame(['Can contain letters, numbers, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last'], $this->validationService->password('ss..ss..ss'));
        self::assertSame(['Can contain letters, numbers, !#$%&‘*+—/\=?^_`{|}~!»№;%:?*()[]<>,\' symbols, and one dot not first or last'], $this->validationService->password('阿阿阿阿阿阿阿阿'));
    ...
    public function  testEmail():void
    {
        ...
        self::assertSame(['Invalid e-mail Address length'], $this->validationService->email('1234567891234567891234567891234566'));
    ...
    public function  testCardholderName():void
    {
        ...
        self::assertSame(['Can contain letters, hyphen and dot'], $this->validationService->cardholderName('ss!@#$%^&*()_+{}":><'));
