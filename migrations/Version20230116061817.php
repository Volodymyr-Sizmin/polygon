...
final class Version20230116061817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE autopayments (id INT AUTO_INCREMENT NOT NULL, user_email VARCHAR(55) NOT NULL, name_of_payment VARCHAR(55) NOT NULL, payment_category VARCHAR(55) NOT NULL, cell_phone_operators VARCHAR(55) DEFAULT NULL, customer_number VARCHAR(55) NOT NULL, amount VARCHAR(55) NOT NULL, card VARCHAR(55) NOT NULL, payments_period VARCHAR(55) NOT NULL, auto_charge_off TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
