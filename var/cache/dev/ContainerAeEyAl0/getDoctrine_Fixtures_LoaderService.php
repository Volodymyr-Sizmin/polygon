...
class getDoctrine_Fixtures_LoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/RegistrationFixtures.php';
        ...
        $instance->addFixtures([0 => ['fixture' => new \App\DataFixtures\RegistrationFixtures(), 'groups' => []]]);
